  ...
  return (
    ...
    <div className="relative z-10 flex items-center justify-center pt-3 sm:pt-5 md:px-5 lg:px-6 xl:px-9 md:pt-9">
      ...
      <div className="flex flex-col-reverse md:flex-row gap-3 w-full sm:bg-transparent  h-screen">
        {/* left side */}
        <div className="w-full md:w-1/2 px-2 sm:px-10 md:p-0 flex items-center justify-center">
          <div className="flex flex-col items-center md:items-start gap-1 md:gap-5 lg:gap-8">
            ...
            border border-myPurple'>
              <p className="text-myPurple sm:text-[15px] text-[11px] md:text-[15px] lg:text-lg">
        ...
        {/* header pictures-1 */}
          <div className="w-24 h-24 sm:w-48 sm:h-48 md:w-40 md:h-40 lg:w-64 lg:h-64 xl:h-80 xl:w-80 absolute 
          left-4 sm:right-[360px] lg:right-[200px] xl:right-[278px]">
            <img className="object-cover h-full w-full" src="/h1.png" alt="header-pics" />
          </div>
          {/* header pictures-2 */}
          <div className="w-32 h-32 sm:w-48 sm:h-48 md:w-48 md:h-48 lg:w-64 lg:h-64 xl:h-80 
          ...
          {/* header pictures-3 */}
          <div className="sm:block hidden sm:w-40 sm:h-40 md:w-40 md:h-40 lg:w-48 lg:h-48 xl:w-52 xl:h-52 
          ...
          {/* header pictures-4 */}
          <div className="sm:block hidden md:w-24 md:h-24 xl:w-28 xl:h-28 absolute left-20 sm:left-36 md:right-[140px] 
